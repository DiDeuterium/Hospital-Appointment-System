...
(5,  '2026-05-16', '上午', 30, 29),   -- 1 个 active (appt 11)
(7,  '2026-05-16', '上午', 15, 15),   -- 0 个 active
(1,  '2026-05-17', '上午', 30, 28),   -- 2 个 active (appt 12,13)
(2,  '2026-05-17', '下午', 20, 20),   -- 0 个 active
(5,  '2026-05-18', '上午', 25, 25),   -- 0 个 active
(6,  '2026-05-18', '下午', 20, 19),   -- 1 个 active (appt 14; appt 15 已取消)
(9,  '2026-05-19', '上午', 30, 27),   -- 3 个 active (appt 16,17,18)
(10, '2026-05-20', '上午', 20, 20),   -- 0 个 active
(12, '2026-05-21', '下午', 25, 25),   -- 0 个 active
(11, '2026-05-22', '上午', 20, 20);   -- 0 个 active
